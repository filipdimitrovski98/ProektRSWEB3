...
namespace Project_1_Final.Controllers
{
    ...
    public class StudentsApiController : ControllerBase
    {
        ...
        public StudentsApiController(Project_1_FinalContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Student>> GetStudent(double id)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Student>> DeleteStudent(double id)
        {
            var student = await _context.Student.FindAsync(id);
            if (student == null)
            {

...
namespace Project_1_Final.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public TeacherController(Project_1_FinalContext context)
        {
            _context = context;
        }
        ...
        {
            var enrollments = await _context.Enrollment.Where(m => m.CourseId == id).Include(m => m.Student).Include(m => m.Course).ToListAsync();
